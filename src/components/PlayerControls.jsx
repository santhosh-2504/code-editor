...
//           <button 
//             onClick={runCode} 
//             className="flex items-center px-4 py-2 rounded-lg bg-green-600 hover:bg-green-700 text-white transition-all duration-200 shadow-lg hover:shadow-xl"
//           >
...
//               </svg>
//               Continue from {editModeEntryIndex}
//             </button>
//           )}
//         </div>
